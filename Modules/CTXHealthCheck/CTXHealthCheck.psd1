...
FunctionsToExport = 'Get-CitrixConfigurationChanges', 'Get-CitrixFarmDetails', 
               'Get-CitrixLicenseInformation', 'Get-CitrixServerEventLogs', 
               'Get-CitrixSingleServerPerformance', 'Get-CitrixWebsiteStatus', 
               'Get-CitrixXA6RemoteFarmDetails', 'Get-RDSLicenseInformation', 
               'Get-StoreFrontDetails', 'Get-CitrixObjects', 'Compare-TwoADUsers', 
