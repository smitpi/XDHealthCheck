...
$UserPage1 = New-UDPage -Name "Users" -Icon user -Content {
...
$DynamicUserPage = New-UDPage -Url "/dynamic/:Username" -Icon user_o -Endpoint {
    ...
    New-UDCard -Text (Get-Date -DisplayHint DateTime).ToString() -BackgroundColor $Session:BGColor -FontColor $Session:Color -TextSize Medium -TextAlignment center
