...
[System.Environment]::SetEnvironmentVariable('PSParameters', "$ParametersFolder.tostring()\Parameters.xml", [System.EnvironmentVariableTarget]::User)
