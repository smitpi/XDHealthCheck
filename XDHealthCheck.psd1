...
FunctionsToExport = 'Compare-TwoADUsers', 'Get-CitrixConfigurationChange', 
               'Get-CitrixFarmDetail', 'Get-CitrixLicenseInformation', 
               ...
               'Get-CTXONP_ConfigAudit', 'Get-CTXONP_ConnectionReport', 
               'Get-CTXONP_FailureReport', 'Get-CTXONP_HealthCheck', 
               'Get-CTXONP_MonitorData', 'Get-CTXONP_ResourceUtilization', 
               'Get-CTXONP_Sessions', 'Get-CTXOPN_VDAUptime', 'Get-FullADUserDetail', 
               'Get-RDSLicenseInformation', 'Get-StoreFrontDetail', 
               'Import-ParametersFile', 'Install-BasePSModules', 
               'Install-ParametersFile', 'Install-UserPSProfile', 
               'Start-CitrixAudit', 'Start-CitrixHealthCheck', 
               'Start-CitrixUserCompare', 'Start-CitrixUserCompareGUI', 
               'Start-CitrixUserDetail', 'Start-CitrixUserDetailGUI', 
               'Start-NetScalerHealthCheck', 'Start-XDHealthCheckGui', 
               'Start-XDMenu'
