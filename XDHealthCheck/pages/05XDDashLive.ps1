			...
			New-UDRow {
				New-UDColumn -Size 12 {
					New-UDLayout -Columns 1  -Content {
						...
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -Title 'RDS Licenses' -Endpoint { $CheckXML.RDSLicenseInformation | Out-UDGridData }
						...
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -Title 'Citrix Events Top Events' -Endpoint { ($CheckXML.CitrixServerEventLogs.TotalProvider | Select-Object -First 10) | Out-UDGridData }
