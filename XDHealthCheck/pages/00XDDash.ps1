			...
			New-UDRow {
				New-UDColumn -Size 12 {
					New-UDLayout -Columns  -Content {
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix Sessions' -Endpoint { $CheckXML.CitrixRemoteFarmDetails.SessionCounts | Out-UDGridData }
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix Controllers' -Endpoint { $CheckXML.CitrixRemoteFarmDetails.Controllers.Summary | Out-UDGridData }

						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix DB Connection' -Endpoint { $CheckXML.CitrixRemoteFarmDetails.DBConnection | Out-UDGridData }
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix Licenses' -Endpoint { $CheckXML.CitrixLicenseInformation | Out-UDGridData }

						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'RDS Licenses' -Endpoint { $CheckXML.RDSLicenseInformation.$RDSLicensType | Out-UDGridData }
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix Error Counts' -Endpoint { ($CheckXML.CitrixServerEventLogs.SingleServer | Select-Object ServerName, Errors, Warning) | Out-UDGridData }

						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix Events Top Events' -Endpoint { ($CheckXML.CitrixServerEventLogs.TotalProvider | Select-Object -First $CTXCore.count) | Out-UDGridData }
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'StoreFront Site' -Endpoint { $CheckXML.StoreFrontDetails.SiteDetails | Out-UDGridData }

						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'StoreFront Server' -Endpoint { $CheckXML.StoreFrontDetails.ServerDetails | Out-UDGridData }
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix Config Changes in the last 7 days' -Endpoint { ($CheckXML.CitrixConfigurationChanges.Summary | where { $_.name -ne "" } | Sort-Object count -Descending | Select-Object -First 5 -Property count, name) | Out-UDGridData }

						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix Server Performace' -Endpoint { ($CheckXML.ServerPerformance) | Out-UDGridData }
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix Delivery Groups' -Endpoint { $CheckXML.CitrixRemoteFarmDetails.DeliveryGroups | Out-UDGridData }


						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix UnRegistered Desktops' -Endpoint { $CheckXML.CitrixRemoteFarmDetails.Machines.UnRegisteredDesktops | Out-UDGridData }
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix UnRegistered Servers' -Endpoint { $CheckXML.CitrixRemoteFarmDetails.Machines.UnRegisteredServers | Out-UDGridData }
						New-UDGrid -NoFilter -NoPaging -PageSize 25 -BackgroundColor '#ffffff' -Title 'Citrix Tainted Objects' -Endpoint { $CheckXML.CitrixRemoteFarmDetails.ADObjects.TaintedObjects | Out-UDGridData }
					}
				}
			} -Elevation 4
			#endregion
