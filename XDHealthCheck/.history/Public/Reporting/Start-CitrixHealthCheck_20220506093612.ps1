...
function Start-CitrixHealthCheck {
	...
	New-HTML -TitleText 'XenDesktop Report' -FilePath $Reportname {
		...
		New-HTMLSection @SectionSettings -Content {
			...
			New-HTMLSection -HeaderText 'Citrix Server Performace' @TableSectionSettings { New-HTMLTable @TableSettings -DataTable ($ServerPerformance) $Conditions_performance }
		}
		...
		New-HTMLSection @SectionSettings -Content { New-HTMLSection -HeaderText "Environment Test" @TableSectionSettings { New-HTMLTable @TableSettings -DataTable $CitrixRemoteFarmDetails.RebootSchedule } }
