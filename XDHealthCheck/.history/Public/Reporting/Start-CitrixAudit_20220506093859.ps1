...
function Start-CitrixAudit {
	...
	#endregion
	Export-Excel -Path $ExcelReportname -AutoSize -AutoFilter -Title 'Catalog Results' -TitleBold -TitleSize 28 -TitleFillPattern LightTrellis -TableStyle Light20 -FreezeTopRow -FreezePane 3
	#######################
