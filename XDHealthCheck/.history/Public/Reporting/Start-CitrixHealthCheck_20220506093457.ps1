...
function Start-CitrixHealthCheck {
	...
	New-HTML -TitleText 'XenDesktop Report' -FilePath $Reportname {
		...
		New-HTMLSection @SectionSettings -Content { New-HTMLSection -HeaderText "edule" @TableSectionSettings { New-HTMLTable @TableSettings -DataTable $CitrixRemoteFarmDetails.RebootSchedule } }
