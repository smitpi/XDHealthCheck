...
Function Get-CitrixFarmDetail {
	...
	if ($Export -eq 'Excel') {  
		$SiteDetails.AllDetails | Export-Excel -Path $(Join-Path -Path $ReportPath -ChildPath "\CitrixFarmDetail-$(Get-Date -Format yyyy.MM.dd-HH.mm).xlsx") -WorksheetName SiteDetails -AutoSize -AutoFilter -Title 'Machine Failures' -TitleBold -TitleSize 28
		$Controllers.AllDetails | Export-Excel -Path $(Join-Path -Path $ReportPath -ChildPath "\CitrixFarmDetail-$(Get-Date -Format yyyy.MM.dd-HH.mm).xlsx") -WorksheetName Controllers -AutoSize -AutoFilter -Title 'Machine Failures' -TitleBold -TitleSize 28
		$Machines.AllMachines | Export-Excel -Path $(Join-Path -Path $ReportPath -ChildPath "\CitrixFarmDetail-$(Get-Date -Format yyyy.MM.dd-HH.mm).xlsx") -WorksheetName Machines -AutoSize -AutoFilter -Title 'Machine Failures' -TitleBold -TitleSize 28
	...
	if ($Export -eq 'HTML') { 
		New-HTML -TitleText "CitrixFarmDetail-$(Get-Date -Format yyyy.MM.dd-HH.mm)" -FilePath $(Join-Path -Path $ReportPath -ChildPath "\CitrixFarmDetail-$(Get-Date -Format yyyy.MM.dd-HH.mm).html") {
			New-HTMLTab -Name 'SiteDetails' -TextTransform uppercase -IconSolid cloud-sun-rain -TextSize 16 -TextColor '#00203F' -IconSize 16 -IconColor '#ADEFD1' -HtmlData {New-HTMLPanel -Content { New-HTMLTable -DataTable $($SiteDetails.AllDetails) @TableSettings}}
			New-HTMLTab -Name 'Controllers' -TextTransform uppercase -IconSolid cloud-sun-rain -TextSize 16 -TextColor '#00203F' -IconSize 16 -IconColor '#ADEFD1' -HtmlData {New-HTMLPanel -Content { New-HTMLTable -DataTable $($Controllers.AllDetails) @TableSettings}}
			New-HTMLTab -Name 'Machines' -TextTransform uppercase -IconSolid cloud-sun-rain -TextSize 16 -TextColor '#00203F' -IconSize 16 -IconColor '#ADEFD1' -HtmlData {New-HTMLPanel -Content { New-HTMLTable -DataTable $($Machines.AllMachines) @TableSettings}}
			New-HTMLTab -Name 'Sessions' -TextTransform uppercase -IconSolid cloud-sun-rain -TextSize 16 -TextColor '#00203F' -IconSize 16 -IconColor '#ADEFD1' -HtmlData {New-HTMLPanel -Content { New-HTMLTable -DataTable $($Sessions) @TableSettings}}
			New-HTMLTab -Name 'DeliveryGroups' -TextTransform uppercase -IconSolid cloud-sun-rain -TextSize 16 -TextColor '#00203F' -IconSize 16 -IconColor '#ADEFD1' -HtmlData {New-HTMLPanel -Content { New-HTMLTable -DataTable $($DeliveryGroups) @TableSettings}}
			New-HTMLTab -Name 'DBConnection' -TextTransform uppercase -IconSolid cloud-sun-rain -TextSize 16 -TextColor '#00203F' -IconSize 16 -IconColor '#ADEFD1' -HtmlData {New-HTMLPanel -Content { New-HTMLTable -DataTable $($DBConnection) @TableSettings}}
			New-HTMLTab -Name 'RebootSchedule' -TextTransform uppercase -IconSolid cloud-sun-rain -TextSize 16 -TextColor '#00203F' -IconSize 16 -IconColor '#ADEFD1' -HtmlData {New-HTMLPanel -Content { New-HTMLTable -DataTable $($RebootSchedule) @TableSettings}}
