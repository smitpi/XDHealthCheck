...
Description = 'Module for daily health checks on a XenDesktop Farm'
...
FunctionsToExport = 'Compare-ADUser', 'Get-CitrixConfigurationChange', 
               'Get-CitrixFarmDetail', 'Get-CitrixLicenseInformation', 
               'Get-CitrixObjects', 'Get-CitrixServerEventLog', 
               'Get-CitrixServerPerformance', 'Get-CitrixSingleServerPerformance', 
               'Get-CitrixUserAccessDetail', 'Get-CitrixWebsiteStatus', 
               'Get-CitrixXA6RemoteFarmDetail', 'Get-FullUserDetail', 
